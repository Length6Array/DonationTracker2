...
/**
 * Hey! This is the Welcome screen! Literally the first thing you see when you open the app It
 * contains two buttons, login and register.
 */
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                if (!matched) {
                    ...
                    Person.credentials.put(
                            person.getEmail(),
                            person.getPassword()); // into a map to be used for other activities
                }
        ...
        if (cursor.moveToFirst()) { // if there's a line to be read
            do {
                ...
                if (!matched) {
                    ...
                    Location.ITEM_MAP.put(
                            l.getName(), l); // into a map to be used for other activities
                }
