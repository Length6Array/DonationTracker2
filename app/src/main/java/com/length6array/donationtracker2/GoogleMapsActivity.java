...
public class GoogleMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(
                new MarkerOptions()
                        .position(afdStation4)
                        .title("AFD Station 4")
                        .snippet(
                                "Address: 309 Edgewood Ave SE, Atlanta, GA 30332"
                                        + "\n"
        ...
        mMap.addMarker(
                new MarkerOptions()
                        .position(boysGirlsClub)
                        .title("Boys & Girls Club W.W. Woolfolk")
                        .snippet(
                                "Address: 1642 Richland Rd, Atlanta, GA 30332"
                                        + "\n"
        ...
        mMap.addMarker(
                new MarkerOptions()
                        .position(pathwayUpperRoom)
                        .title("Pathway Upper Room Christian Ministries")
                        .snippet(
                                "Address: 1683 Sylvan Rd, Atlanta, GA 30332"
                                        + "\n"
        ...
        mMap.addMarker(
                new MarkerOptions()
                        .position(pavilionOfHope)
                        .title("Pavilion of Hope Inc.")
                        .snippet(
                                "Address: 3558 East Ponce de Leon Ave, Scottdale, GA 30079"
                                        + "\n"
        ...
        mMap.addMarker(
                new MarkerOptions()
                        .position(ddConvenienceStore)
                        .title("D&D Convenience Store")
                        .snippet(
                                "Address: 2426 Columbia Drive, Decatur, GA 30034"
                                        + "\n"
        ...
        mMap.addMarker(
                new MarkerOptions()
                        .position(keepNFBeautiful)
                        .title("Keep North Fulton Beautiful")
                        .snippet(
                                "Address: 470 Morgan Falls Rd, Sandy Springs, GA 30302"
                                        + "\n"
        ...
        LatLngBounds bounds =
                new LatLngBounds(new LatLng(33.70, -84.442), new LatLng(33.97, -84.25));
