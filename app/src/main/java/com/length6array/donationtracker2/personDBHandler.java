...
/**
 * This class represents the Person Database Handler. It uses SQL to add, create, etc. people.
 */
public class PersonDBHandler extends SQLiteOpenHelper {
     ...
     */
         ...
         * @return A boolean representing whether or not the Person is accurately added to the table
         */
        ...
        /**
         * This method deletes a person from the database using the user's name
         *
         * @param user  String representing the name of a user
         */
         ...
         *
         * @return String representing data from database
         */
        ...
        /**
         * Returns a cursor pointing to tables of data from the database
         *
         * @return returns a query getting all users
         */
