...
public class DonationActivity extends AppCompatActivity {
    ...
    public static List<String> categories =
            Arrays.asList("Clothing", "Hat", "Kitchen", "Electronics", "Household", "Other");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        startActivity(
                                (new Intent(DonationActivity.this, LocationListActivity.class)));
                    }
                });
        ...
        ArrayAdapter<String> adapter1 =
                new ArrayAdapter(this, android.R.layout.simple_spinner_item, locationName);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                            ...
                            if (value.getText() != null) {
                                if (description != null) {
                                    if (type != null) {
                                        ...
                                        newDonation.setDescription(
                                                description.getText().toString());
                                        newDonation.setValue(value.getText().toString());
                                        newDonation.setLocation(
                                                Location.ITEM_MAP.get(
