...
/**
 * A fragment representing a single Donations detail screen. This fragment is either contained in a
 * {@link DonationsListActivity} in two-pane mode (on tablets) or a {@link DonationsDetailActivity}
 * on handsets.
 */
    ...
    public View onCreateView(
        ...
        if (donation != null) {
            ((TextView) rootView.findViewById(R.id.location))
                    .setText("Location: " + donation.getLocation());
            ((TextView) rootView.findViewById(R.id.type))
                    .setText("Item Type: " + donation.getType());
            ((TextView) rootView.findViewById(R.id.value))
                    .setText("Value: $" + donation.getValue());
            ((TextView) rootView.findViewById(R.id.date))
                    .setText("Date Added: " + donation.getDateAdded());
            ((TextView) rootView.findViewById(R.id.description))
                    .setText("Description: " + donation.getDescription());
        }
