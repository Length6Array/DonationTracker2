...
public class PersonDBHandler extends SQLiteOpenHelper {
    ...
    /**
     * Hey! This is the database, its actually not that complicated really its just a table of
     * values that correspond to attributes of the Donation class. Hopefully my comments will help
     * you figure out what's going on, otherwise here are the two resources I used to get this thing
     * working
     *
     * <p>https://www.simplifiedcoding.net/sqliteopenhelper-tutorial/#Creating-the-Employee //this
     * was more helpful in learning how to grab the information stored in the database and put it
     * into an arraylist
     *
     ...
     *
     * <p>Go to DonationActivity to see how I put donations in Go to DonationListActivity to see how
     * I pull these values out
     *
     * <p>Side Note: there will most likely be an error after you make Location database, go to
    ...
    public void deleteUser(String user) {
        SQLiteDatabase db = getWritableDatabase();
        db.execSQL("DELETE FROM " + TABLE_USERS + " WHERE " + COLUMN_EMAIL + "=\"" + user + "\";");
    }
