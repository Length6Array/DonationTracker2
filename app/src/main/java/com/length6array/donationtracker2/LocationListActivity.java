...
/**
 * OKAYYY this is the LocationListActivity!!! Get excited! We're now in the legit app!! WOaH What's
 * going on: A ~recyclerView~ (a layout that allows for scrolling thru a list in a cool and space
 * efficient way- it RECYCLES views! Wow! Wild! so basically it takes the view that went off screen
 * during scrolling and puts it at the bottom with NEW info! How cool!) takes all the locations and
 * makes them into a scrolling list. When you click on a location, it will take you to the Detail
...
public class LocationListActivity extends AppCompatActivity {
        ...
        openMap.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        startActivity(
                                (new Intent(LocationListActivity.this, GoogleMapsActivity.class)));
                    }
                });
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        SimpleItemRecyclerViewAdapter(
                LocationListActivity parent, List<Location> items, boolean twoPane) {
            mValues = items;
